...
class Document
{
     ...
     * @throws Exception
     */
    public function mergeDocuments(array $sourceFiles = [])
    {
        ...
        //Build JSON to post
        $documentsList = ['List' => $sourceFiles];
     ...
     * @param string $fieldType  A value indicating the type of the form field. Available values - text, boolean,
     *                           integer, list.
