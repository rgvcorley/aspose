...
class Document
{
    ...
    public function updateFields()
    {
        ...
        AsposeApp::getLogger()->info('WordsDocument updateFields call will be made', [
            'call-uri' => $strURI,
        ])
        ;
        ...
        AsposeApp::getLogger()->warning('Error occured, http 200 code was not found.', [
            'json-code' => $json->Code,
        ])
        ;
        return false;
    ...
    public function rejectTrackingChanges()
    {
        ...
        AsposeApp::getLogger()->info('WordsDocument rejectTrackingChanges call will be made', [
            'call-uri' => $strURI,
        ])
        ;
    ...
    public function acceptTrackingChanges()
    {
        ...
        AsposeApp::getLogger()->info('WordsDocument acceptTrackingChanges call will be made', [
            'call-uri' => $strURI,
        ])
        ;
    ...
    public function getStats(array $options = [])
    {
        ...
        AsposeApp::getLogger()->info('WordsDocument getStats call will be made', [
            'call-uri' => $strURI,
        ])
        ;
     ...
     * @see OptionsResolver
     */
    public function splitDocument(array $options = [])
    {
        ...
        AsposeApp::getLogger()->info('WordsDocument splitDocument call will be made', [
            'call-uri' => $strURI,
        ])
        ;
    ...
    public function appendDocument($appendDocs, $importFormatModes, $sourceFolder)
    {
        ...
        foreach ($appendDocs as $doc) {
            $post_array[] = ["Href"             => (($sourceFolder != "") ? $sourceFolder . "\\" . $doc : $doc),
        ...
        AsposeApp::getLogger()->warning('Error occured, output could not be validated.', [
            'v-output' => $v_output,
        ])
        ;
        return $v_output;
    ...
    {
        $resolver = new OptionsResolver();
        $resolver->setRequired(['propertyName', 'propertyValue']);
        $options = $resolver->resolve($options);
     ...
     *                       <li>'ProtectionType' => (string) Document protection type, one from: AllowOnlyComments,
     *                       AllowOnlyFormFields, AllowOnlyRevisions, ReadOnly, NoProtection</li>
     *                       </ul>
     *
    ...
    public function protectDocument(array $options)
    {
        ...
        $resolver->setRequired('Password')
                 ...
                 ->setAllowedValues('ProtectionType', [
                     'AllowOnlyComments',
                     'AllowOnlyFormFields',
                     'AllowOnlyRevisions',
                     'ReadOnly',
    ...
    public function updateProtection($oldPassword, $newPassword, $protectionType = 'AllowOnlyComments')
    {
        ...
        $fieldsArray = ['Password' => $oldPassword, 'NewPassword' => $newPassword, 'ProtectionType' => $protectionType];
     ...
     * @throws Exception
     */
    public function compareDocument($compareWithFilename, array $compareData = [], array $options = [])
    {
        // POST parameters
        $resolver = new OptionsResolver();
        $resolver
        ...
        AsposeApp::getLogger()
                 ->warning('Error occured while processing `compareDocument` command, HTTP 200 code or result `Document` was not found.',
                     [
                         'json-code' => $json->Code,
                     ])
        ;
