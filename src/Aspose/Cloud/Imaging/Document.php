...
class Document
{
     ...
     * @throws Exception
     */
    public function updateBMPPropertiesFromLocalFile($inputPath,
        $bitsPerPixel,
     ...
     * @throws Exception
     */
    public function updateGIFPropertiesFromLocalFile($inputPath,
     ...
     * @throws Exception
     */
    public function updateTIFFProperties($resolutionUnit,
        $newWidth,
        $newHeight,
        $horizontalResolution,
        $verticalResolution,
     ...
     * @throws Exception
     */
    public function updateTIFFPropertiesFromLocalFile($inputPath,
        $compression,
        $resolutionUnit,
        $newWidth,
        $newHeight,
