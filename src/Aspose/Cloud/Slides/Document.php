...
class Document
{
     ...
     * @throws Exception
     */
    public function splitPresentation($from = '',
        $to = '',
        $destination = '',
        $format = '',
        $storageName = '',
     ...
     * @throws Exception
     */
    public function mergePresentations($presentationsList = [], $storageName = '', $folder = '')
    {
     ...
     * @throws Exception
     */
    public function mergePresentationsByFileNames($fileNames = [], $storageName = '', $folder = '')
    {
        ...
        $json_data = json_encode(['PresentationPaths' => $fileNames]);
