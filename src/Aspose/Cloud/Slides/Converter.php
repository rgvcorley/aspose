...
class Converter
{
     ...
     * @param type $textCompression            Specifies compression type to be used for all textual content in the
     *                                         document.
     * @param type $embedFullFonts             Determines if all characters of font should be embedded or only used
     *                                         subset.
