...
class Worksheet
{
    ...
    public function updateHyperlink($hyperlinkIndex, $url, $screenTip, $displayText)
    {
        ...
        $data = ['address' => $url, 'ScreenTip' => $screenTip, 'TextToDisplay' => $displayText];
     ...
     * @throws Exception
     */
    public function addPicture($picturePath,
        $pictureLocation,
        $upperLeftRow = 0,
        $upperLeftColumn = 0,
        $lowerRightRow = 0,
        ...
        if ($pictureLocation == 'Server' || $pictureLocation == 'server') {
            ...
            if ($pictureLocation == 'Local' || $pictureLocation == 'local') {
     ...
     * @throws Exception
     */
    public function addOleObject($oleFile = '',
        $imageFile = '',
        $upperLeftRow = 0,
        $upperLeftColumn = 0,
        $height = 0,
