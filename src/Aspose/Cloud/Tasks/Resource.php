...
class Resource
{
     ...
     * @param string  $changedFileName The name of the project document to save changes to. If this parameter is
     *                                 omitted then the changes will be saved to the source project document.
     *
